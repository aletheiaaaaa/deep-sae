...
from .sae import DeepSAE, device
...
def train_sae(deep: DeepSAE, shallow: DeepSAE, train_cfg: TrainConfig) -> None:
    model = LanguageModel(
        "google/gemma-3-1b-pt", device_map=device, torch_dtype=torch.float16
    )
